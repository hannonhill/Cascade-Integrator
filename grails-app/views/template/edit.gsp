...
<%@ page import="com.hannonhill.integrator.Template" %>
<html>
    <head>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="site"><g:message code="template.site.label" default="Site" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: templateInstance, field: 'site', 'errors')}">
                                    <g:select name="site.id" from="${com.hannonhill.integrator.Site.list()}" optionKey="id" value="${templateInstance?.site?.id}"  />
                                </td>
                            </tr>
